...
use AppBundle\Form\PhysicalCustomerType;
 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\PhysicalCustomerRepository")
 */
class PhysicalCustomer extends AbstractCustomer implements EntityCrudInterface
{
     ...
     *
     * @param \AppBundle\Entity\CustomerDocumentType $identityDocumentType
     *
     * @return PhysicalCustomer
     */
    public function setIdentityDocumentType(\AppBundle\Entity\CustomerDocumentType $identityDocumentType = null)
    {
     ...
     *
     * @return \AppBundle\Entity\CustomerDocumentType
     */
