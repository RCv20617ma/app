...
use AppBundle\Entity\ReferencePhoneType;
...
class CustomerPhone
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\ReferencePhoneType")
     ...
     * Set type
     *
     * @param \AppBundle\Entity\ReferencePhoneType $type
     *
     * @return AbstractCustomerPhone
     */
    public function setType(\AppBundle\Entity\ReferencePhoneType $type = null)
    {
        $this->type = $type;
     ...
     * Get type
     *
     * @return \AppBundle\Entity\ReferencePhoneType
     */
